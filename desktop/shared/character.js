...
import { drawEyeType, drawEffect, drawMatrixBackground } from './effects.js';
...
export function drawCharacter(eyeType, effect, currentState, currentCharacter, animFrame) {
  ...
  drawEyeType(eyeType, char, animFrame, drawRect);

  // Draw effect (sparkle, thinking, alert, zzz, none)
  // Note: matrix effect is handled above as background
  drawEffect(effect, char, animFrame, drawRect);
}
